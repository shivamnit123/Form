...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Avatar bg="gray.800" />
        <Heading color="gray.800">Lets Join with us</Heading>
            ...
            >
              ...
              <FormControl>
                <InputGroup>
                  <InputLeftElement
                    pointerEvents="none"
                    children={<CFaEnvelope color="gray.700" />}
                  />
              ...
              <FormControl>
                <InputGroup>
                  <InputLeftElement
                    pointerEvents="none"
                    children={<CFaPhone color="gray.700" />}
                  />
                  <Input
                    type="tel"
                    name="phone"
      ...
      <Box>
        Already Login?{" "}
        <Link color="teal.800" fontWeight={600} href="/">
          Sign in
        </Link>
      </Box>
    </Flex>
